...
origin_image_path = '/workvol/home1/lyt/datasets/NIH-CXR8/images/images'
image_label_list = 'data/list/binary_classification_20k.txt'
...
def get_split(split_name, dataset_dir, file_pattern=file_pattern, file_pattern_for_counting='chest14'):
    '''
...
def load_batch(dataset, batch_size, height=image_size, width=image_size, is_training=True, num_epochs=None):
    '''
    ...
    common_queue_min = 24 if is_training else 2*batch_size
