...
from train_pne import load_batch

plt.style.use('ggplot')
slim = tf.contrib.slim

#State your log directory where you can retrieve your model
log_dir = 'eval/pne_log/pne_log'

#Create a new evaluation log directory to visualize the validation process
log_eval = 'eval/eval_visual'

#State the dataset directory where the validation set is found
dataset_dir = '/workvol/home1/lxz/proj/muti_label_classification/data/tfrecord'
...
def run():
    ...
    with tf.Graph().as_default() as graph:
        ...
        dataset = get_split('validation', dataset_dir, 'chest14_%s_*.tfrecord', 'chest14')
        ...
        predictions = tf.argmax(end_points['Predictions'], 1) ## first
